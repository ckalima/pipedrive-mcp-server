  ...
  // U2: Stage write tools
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        days_to_rotten: { type: ["number", "null"], description: "Days until a deal not updated in this stage becomes rotten (applies only when is_deal_rot_enabled is set; null to clear)" },
      },

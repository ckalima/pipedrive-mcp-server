...
export const userTools = [
  ...
  },
  {
    ...
    description: "Identify the Pipedrive account this server is connected to: returns the connected company (name, id, and domain) alongside the API key owner's user details. Use it to confirm which company the data is coming from, or to get your user ID.",
    inputSchema: {
      type: "object" as const,
      properties: {},
    },

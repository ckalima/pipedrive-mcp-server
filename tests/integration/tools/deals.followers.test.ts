...
import { DealFollowersChangelogSchema, ListDealFollowersSchema } from '../../../src/schemas/deals.js';
...
describe('deal follower tools (U1, #69)', () => {
  ...
  describe('listDealFollowers', () => {
    it('should call v2 /deals/{id}/followers endpoint', async () => {
      ...
      await listDealFollowers(ListDealFollowersSchema.parse({ id: 3 }));
    ...
    it('should forward cursor when present', async () => {
      ...
      await listDealFollowers(ListDealFollowersSchema.parse({ id: 3, cursor: 'follcursor' }));
    ...
    it('should surface next_cursor in pagination', async () => {
      ...
      const result = await listDealFollowers(ListDealFollowersSchema.parse({ id: 3 }));
  ...
  describe('getDealFollowersChangelog', () => {
    it('should call GET /deals/{id}/followers/changelog', async () => {
      ...
      await getDealFollowersChangelog(DealFollowersChangelogSchema.parse({ id: 3 }));
    ...
    it('should surface pagination from changelog response', async () => {
      ...
      const result = await getDealFollowersChangelog(DealFollowersChangelogSchema.parse({ id: 3 }));
